...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html"><img src="https://storage.googleapis.com/projekgaul/innova-2016-removebg-preview.png">2ND Mobil Bekas Malang</a></h1>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>2ND Mobil Malang</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">VennyIsma</a>
      </div>
    </div>
  </footer><!-- End Footer -->
